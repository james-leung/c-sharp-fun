...
namespace MagicSquare
{
    class Program
    {
        ...
        public class MagicSquareGenerator
        {
            ...
            {
                var square = CreateRandomSquare(size);
                while (!_verifier.Verify(_splitter.Split(square)))
                {
                    square = CreateRandomSquare(size);
                }
                return square;
            }

            private List<List<int>> CreateRandomSquare(int size)
            {
